    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          {/* Backdrop: a native button so click-to-close is keyboard/mouse accessible. */}
          <button
            type="button"
            aria-label="Close"
            onClick={close}
          ...
          <div
            ...
            className="relative w-full max-w-lg max-h-[80vh] flex flex-col bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700"
          >
            {/* Header */}
